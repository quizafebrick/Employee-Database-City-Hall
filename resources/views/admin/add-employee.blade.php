                                        ...
                                        <div class="grid grid-cols-9 gap-3 text-center">
                                            ...
                                            <div class="col-span-3 sm:col-span-3">
                                                ...
                                                <div class="flex items-center justify-center">
                                                    ...
                                                    <label for="remember-me" class="block ml-2 text-sm font-semibold text-red-600 font-robotoBold ">
                                                        If middlename is Not Applicable (N/A)
                                                    </label>
                                                </div>
                                    ...
                                    <div class="px-4 py-5 pb-3 bg-white rounded-t-lg sm:p-6">
                                        ...
                                        <div class="grid grid-cols-9 gap-3 pb-5 text-center">
                                            <div class="col-span-3 sm:col-span-3">
                                                ...
                                                <input type="text" name="philhealth" id="philhealth" class="block w-full mt-1 font-medium text-black border-2 border-solid rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="{{ old('philhealth') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                                            ...
                                            <div class="col-span-3 sm:col-span-3">
                                                ...
                                                <span class="py-2 text-sm font-medium text-red-600 errorBT2 ">@error('blood_type') {{ $message }} @enderror</span>
                                                {{-- MESSAGE VALIDATION --}}
