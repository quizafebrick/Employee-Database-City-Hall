...
<section>
    ...
    @endif
        <div class="w-full p-0 py-8 mt-3 text-black md:mt-20 md:p-16">
            <div class="p-16 mx-10 rounded-lg shadow-lg bg-slate-300">
                <h3 class="text-3xl font-medium text-center text-black underline md:text-5xl ">Archive Employee's Information</h3>
                ...
                <div class="flex items-center justify-center">
                    <a href="{{ route('superadmin.add-employee') }}" class="p-2 py-3 font-semibold text-white rounded-md font-robotoBold bg-primary hover:bg-secondary">Add Employee</a>
                </div>
                {{-- ARCHIVE TABLE --}}
                <livewire:employee-archive-table/>
                {{-- HORIZONTAL LINE: SEPARATOR --}}
                <div class="sm:block" aria-hidden="true">
                    <div class="py-2 mt-3">
                        <div class="border-b-2 border-slate-400"></div>
        ...
        {{-- BACKGROUND IMAGE --}}
        {{-- <img src="{{ asset('img/chall_bg3.jpg') }}" alt="City_Hall_Logo" class="hidden object-cover max-h-screen min-h-screen md:flex"> --}}
    </div>
</section>
