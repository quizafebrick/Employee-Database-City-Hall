        ...
        <div class="w-full p-0 py-8 mt-2 rounded-lg md:mt-20 md:p-10">
            <div class="p-10 mx-4 rounded-lg shadow-lg md:p-16 md:mx-14 bg-slate-300">
                ...
                <div class="flex items-center justify-center">
                    ...
                    <a href="{{ route('superadmin.view-scan-employee') }}" class="p-2 py-3 mx-5 font-semibold text-white rounded-md font-robotoBold bg-primary hover:bg-secondary">Scan QR</a>
                    <a href="{{ route('superadmin.archive-employee') }}" class="p-2 py-3 font-semibold text-white rounded-md font-robotoBold bg-primary hover:bg-secondary">View Archive</a>
                </div>
                {{-- TABLE OF ALL EMPLOYEE --}}
                <livewire:super-admin-employee-table/>
                {{-- HORIZONTAL LINE: SEPARATOR --}}
                <div class="sm:block" aria-hidden="true">
                    <div class="py-2 mt-3">
                        <div class="border-b-2 border-slate-400"></div>
