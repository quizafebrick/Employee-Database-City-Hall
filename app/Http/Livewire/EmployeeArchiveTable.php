...
final class EmployeeArchiveTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        // ONLY TRASHED IS FOR THOSE EMPLOYEE WHO HAS A VALUE OF DELETED_AT FIELD
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
                ...
                ->addColumn('deleted_at_formatted', fn (Employee $model) => Carbon::parse($model->updated_at)->format('d/m/Y H:i:s'));
    }
    ...
    */
    ...
    {
       return [
            // GET THE ID OF SPECIFIC EMPLOYEES TO MAKE AN ACTION(RESTORE OR PERMANENTLY DELETE)
            Button::make('restore', 'Restore')
                    ...
                    ->openModal('employee-restore-confirm', ['id' => 'id']),


            Button::make('delete', 'Delete')
                    ->class('bg-primary hover:bg-secondary font-robotoBold cursor-pointer text-white px-3 py-2 m-1 rounded text-sm font-semibold')
                    ->openModal('employee-delete-confirm', ['id' => 'id']),
        ];
    }
