...
final class SuperAdminEmployeeTable extends PowerGridComponent
{
    use ActionButton;
    ...
    public function actions(): array
    {
        return [
            ...
            Button::make('edit', 'Edit')
                ...
                ->route('superadmin.edit-employee', ['linkToken' => 'link_token', 'id' => 'id']),
            ...
            Button::make('remove', 'Remove')
                ->class('bg-red-500 hover:bg-hovered_error font-robotoBold cursor-pointer text-white px-3 py-2 m-1 rounded text-sm font-semibold')
                ->openModal('employee-remove-confirm', ['id' => 'id']),
        ];
    }
